...
<div id="sectContact" style="background: url(<?php echo get_field('background_produit', 'option')['url']; ?>) no-repeat fixed;background-size: cover;">
    <div class="container">
        <div class="row mb-5">
            ...
            <div class="col-lg-10 col-md-12 ps-4 pt-5">
                ...
                <div class="row">
                <?php echo do_shortcode('[contact-form-7 id="adeb1f9" title="Contact form 1"]'); ?>   
            </div>
            </div>
        </div>
    </div>
